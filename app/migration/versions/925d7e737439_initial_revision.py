...
Revision ID: 925d7e737439
Revises: 
Create Date: 2025-03-08 19:32:16.721090
...
def upgrade() -> None:
    ...
    sa.Column('car_type', sa.Enum('light', 'suv', 'jeep', 'microbus', name='cartypeenum'), nullable=False),
