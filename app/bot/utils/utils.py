...
def get_price_list() -> str:
    ...
    price_message = (
        "🌟 Прайс-лист 🌟\n"
        "  Цены указаны в порядке: Легковой/Кроссовер/Внедорожник/Микроавтобус\n"
        "• Экспресс-мойка: 100/150/200/250\n"
        "• Бесконтактная мойка: 350/400/450/500\n"
        "• Двухфазная мойка: 550/600/650/700\n"
        "• ВИП-Комплекс: 800/850/900/950\n"
        "• Обработка воском: 200/220/240/260\n"
        "• Обезжиривание кузова: 400/500/600/700\n"
        "• Мойка ковров: Легковой - 50/50/50/80\n"
        "• Пылесос салона: 100/120/150/180\n"
    )
